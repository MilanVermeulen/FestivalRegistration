...
class __TwigTemplate_9aaa22f318fb1f335085cfd5a5d75d6b extends Template
{
    private $source;
    private $macros = [];
...
{% block panel %}
    ...
    {% endfor %}
{% endblock %}
", "@Debug/Profiler/dump.html.twig", "/Volumes/Projects/fullstack/stage/FestivalRegistration/vendor/symfony/debug-bundle/Resources/views/Profiler/dump.html.twig");
    }
}
